<html>
    <body>
      <div>Admin - <a href="/wdv441/week7/public_html/login.php">Login here</a></div>

        <div>Users - <a href="/wdv441/week7/public_html/user-edit.php">Add New User</a></div>
        <div>
            ...
            <table border="1">
                ...
                { ?>
                    <tr>
                        ...
                        <td><a href="/wdv441/week7/public_html/user-edit.php?userID=<?php echo $userData['user_id']; ?>">Edit</a></td>
                        <td><a href="/wdv441/week7/public_html/user-view.php?userID=<?php echo $userData['user_id']; ?>">View</a></td>
