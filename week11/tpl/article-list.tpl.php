            ...
            <table border="1">
                ...
                { ?>
                    <tr>
                        ...
                        <td><a href="/wdv_441/week7/public_html/article-edit.php?articleID=<?php echo $articleData['articleID']; ?>">Edit</a></td>
                        <td><a href="/wdv441/week7/public_html/article-view.php?articleID=<?php echo $articleData['articleID']; ?>">View</a></td>
